...
下载离线镜像包
```
docker pull registry.cn-hangzhou.aliyuncs.com/openharbor/harbor_images_aarch64:v2.13.0
```

创建一个新的容器实例
```
TEMP_CONTAINER_ID=$(docker create registry.cn-hangzhou.aliyuncs.com/openharbor/harbor_images_aarch64:v2.13.0 /bin/true)
```
...
如果你希望自己及时构建自己的Harbor ARM64镜像，最简单的方法是fork本项目到你自己github账号，然后修改代码里的镜像名称前缀 registry.cn-hangzhou.aliyuncs.com/openharbor/ 为你自己的即可。
